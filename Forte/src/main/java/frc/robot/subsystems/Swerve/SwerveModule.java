...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants) {
        ...
        angleEncoder = new CANcoder(moduleConstants.absoluteEncoderPorts, "drivetrain/shooter");
    ...
    private void configAngleMotor() {
        ...
        // angleMotor.enableVoltageCompensation(Constants.Swerve.voltageComp); refer to
        // the note below
    ...
    public SwerveModulePosition getPosition() {
        return new SwerveModulePosition(
                Conversions.neoToMeters(driveEncoder.getPosition(), Constants.Swerve.wheelCircumference,
