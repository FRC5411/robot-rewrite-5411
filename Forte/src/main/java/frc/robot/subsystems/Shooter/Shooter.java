...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    topMotor = new TalonFX(ShooterConstants.UPPER_ROLLER_PORT);
    bottomMotor = new TalonFX(ShooterConstants.LOWER_ROLLER_PORT);
  ...
  public double getPivotAngle(){
    return (pivotEncoder.getAbsolutePosition() * pivotGearRatio) - ShooterConstants.PIVOT_OFFSET;
  }
